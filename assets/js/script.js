...
// https://api.flickr.com/services/rest?api_key=d12447f70e875413282a48b9cbe48257&extras=url_h&format=json&method=flickr.photos.search&nojsoncallback=1&page=1&tags=NAMEHERE...
...
function getImgs(){
   ...
   // incase input null
    ...
    console.log(Search)
    fetch(`${url}api_key=${key}&extras=url_h&format=json&method=flickr.photos.search&nojsoncallback=1&page=1&tags=${Search}`)
    .then(res => res.json())
    .then(img => {
        imgdata = img.photos.photo;
        // console.log(imgdata[0].url_h)
